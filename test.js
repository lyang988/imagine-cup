var ints = [   
    ...
    {"type": "regular", "text": "Then the transition to Java’s type system will be quite simple. This course will use typing hints liberally.)"},
    {"islinebreak": true, "type": "linebreak"},
    ...
    {"islinebreak": true, "type": "linebreak"},
    {"type": "regular", "text": "In general, you will probably want to avoid overflow. There are types that will more closely approximate Python’s "},
    {"iscodetext":true,"language": "python", "type": "codetext", "text": "int"},
    {"type": "regular", "text": "s which will be mentioned later."},
    {"islinebreak": true, "type": "linebreak"},
...
var stringandprint = [
    ...
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "String"},
    {"type": "regular", "text": " keyword and, like Python, are essentially an array of characters. For example, in Python we can define a string "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "s"},
    {"type": "regular", "text": " using:"},
    {"iscode":true,"language": "python", "type": "code", "text": "s = \"This is a String\"\nc = s[0] # the value of c is now ‘T’"},
    ...
    {"type": "regular", "text": " library. These functions can be called on any object which will then be converted to a String and printed. For example,"},
    {"iscode":true,"language": "java","type": "code", "text": "import java.io.*\n\nSystem.out.println(\"hi\");\nSystem.out.print(\"hello\");\nSystem.out.print(5);"},
    {"type": "regular", "text": "will result in"},
    {"iscode":true,"language": "java","type": "code", "text": "hi\nhello5"},
    {"type": "regular", "text": "Here are some other useful String functions in Java with equivalents in Python, with an explanation of how they are used:"},
    ...
    {"islinebreak": true, "type": "linebreak"},
    {"type": "regular", "text": "Like Python, we can also add Strings to other Strings to concatenate them. Unlike in Python, adding other datatypes to a String will convert the datatype to a String and concatenate them. For example:"},
    ...
    {"type": "regular", "text": "In order to compare strings in Java, we can use the "},
    ...
    {"iscodetext":true,"language": "java","type": "codetext", "text": "compareTo"},
    {"type": "regular", "text": "compares the Strings lexicographically and returns 0 if the strings are equal, an integer < 0 if the string is lexicographically less than the other string, and an integer > 0 if the string is lexicographically greater than the other string. For example:"},
...
var floatlongdouble = [
    ...
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "int"},
    {"type": "regular", "text": " types in Java. Integers are restricted to a maximum value of "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "2^31-1 = 2147483647"},
    {"type": "regular", "text": " and a minimum value of "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "-2^32 = -2147483648"},
    {"type": "regular", "text": " as this is the range of representable 32-bit numbers in Two's Complement. Instead, larger integers are defined by the type "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "long"},
    {"type": "regular", "text": " which are 64 bit and have a range of [2^64-1, -2^64]."},
    {"islinebreak": true, "type": "linebreak"},
    {"type": "regular", "text": "We can get the maximum and minimum integer values using the constants "},
    ...
    {"type": "regular", "text": " in Python. Floating point numbers in Java default as a"},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "double"},
    {"type": "regular", "text": "."},
    {"islinebreak": true, "type": "linebreak"},
    {"type": "regular", "text": "Here are some example primitive definitions:"},
    {"iscode":true,"language": "java","type": "code", "text": "int i1 = 2147483647 // Allowed\nint i2 = 2147483648 // Not allowed (Integer overflow error)\nlong l = 2147483648 // Allowed\ndouble d = 5.0/1.5 //Allowed\n\nif (i < 99.9) {...} // The 99.9 is of type double by default\n"},
]
...
var boolandif = [
    ...
    {"type": "regular", "text": ", "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": ")"},
    {"type": "regular", "text": "). Second, the code block guarded by the condition must be enclosed in curly brackets "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "{"},
    {"type": "regular", "text": ", "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "}"},
    ...
    {"type": "regular", "text": "."},
    {"islinebreak": true, "type": "linebreak"},
    {"type": "regular", "text": "So, as an example to put these together, consider the following equivalent Python and Java code:"},
    {"islinebreak": true, "type": "linebreak"},
    {"type": "regular", "text": "Python:"},
    {"iscode":true,"language": "python","type": "code", "text": "z : int = -1;\nif x == 0:\n    z = 10\nelif x == 1:\n    z = 100\nelse:\n    z = 12"},
    {"type": "regular", "text": "Java"},
    {"iscode":true,"language": "java","type": "code", "text": "int z = -1\nif (x == 0) {\n    z = 10;\n} else if (x == 1) {\n    z = 100;\n} else {\n    z = 12;\n}"},
    {"type": "regular", "text": "Observe that we do not place a semicolon after a closing curly bracket, as this bracket is sufficient to indicate that the statement ends."},
    {"islinebreak": true, "type": "linebreak"},
    {"type": "regular", "text": "Generally, if there is only one statement in an if statement, it is good style to omit the brackets:"},
    ...
    {"type": "regular", "text": " variable "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "a"},
    {"type": "regular", "text": " is even, to "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "9"},
    {"type": "regular", "text": " if "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "a"},
    {"type": "regular", "text": " is divisible by three, or to "},
    {"iscodetext":true,"language": "java", "type": "codetext", "text": "10"},
    {"type": "regular", "text": "othwrwise."},
...
var questions = [
    ...
    {lessonName: "Simple Data Types: Booleans", question: {id: "Bools_IDE", type: "code", data: JSON.stringify({
        language : "java",
        startercode : ['import java.util.ArrayList;', 'import java.util.Scanner;', 'import java.io.File;', '', 'class Main {', '\tprivate static int evenOddNumbers(int a) {', '\t\tint b;', '\t\t// MODIFY CODE FROM HERE', '', '', '', '\t\t// DO NOT MODIFY PAST THIS LINE', '\t\treturn b;', '\t}', '', ' \tpublic static void main(String[] args) throws Exception {', '\t\tString filename = args[0];', '\t\tScanner scanner = new Scanner(new File(filename));', '', '\t\tArrayList<Integer> arr = new ArrayList<>();', '\t\twhile (scanner.hasNextInt()) {', '\t\t\tarr.add(scanner.nextInt());', '\t\t}', '\t\tscanner.close();', '', '\t\tfor (int i = 0; i < arr.size(); i++) {', '\t\t\tSystem.out.println(evenOddNumbers(arr.get(i)));', '\t\t}', '\t}', '}', ''],
        compilationCommand: "javac Main.java",
        executionCommand: "java Main input.txt",
        input: "0\n2\n-2\n102\n-1204\n3\n-3\n99\n-99\n237\n-237\n1\n-1\n73\n-73\n107\n-107\n",
        timeout: 5,
